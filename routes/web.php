...
Route::group(['middleware' => ['auth']], function ()
{
    ...
    //Routes for offer letter
    Route::resource('offer-letter', 'OfferLetterController');
    Route::get('my-offer-letter/{id}', ['uses' => 'OfferLetterController@myOfferLetter'])->name('my.offer.letter');

    //Routes for experience letter
    Route::resource('experience-letter', 'ExperienceLetterController');

    //Routes for skill set
    ...
    Route::get('policies', ['uses' => 'PolicyController@policies'])->name('policy.policies');

    //Routes for invoice
    Route::resource('invoice', 'InvoiceController');
    Route::get('invoice-send', ['uses' => 'InvoiceController@send'])->name('invoice.send');
    Route::post('get-client-invoice', ['uses' => 'InvoiceController@getClientInvoice'])->name('get.client.invoice');
    Route::post('invoice-send-to-client', ['uses' => 'InvoiceController@sendInvoiceToClient'])->name('invoice.send.to.client');

    //Routes for payment details
    Route::resource('payment-details', 'PaymentDetailsController');

    //Routes for company expenses
    Route::resource('company-expense', 'CompanyExpenseController');

    //Routes for experience letter
    Route::resource('digital-sig', 'DigitalSignatureController');
...
//Route to accept offer letter by employee and submit to company
