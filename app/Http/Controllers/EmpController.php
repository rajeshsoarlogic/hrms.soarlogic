...
class EmpController extends Controller
{
    ...
    public function processEmployee(Request $request)
    {
        ...
        //$user->email    = str_replace(' ', '_', $request->emp_email) . '@sipi-ip.sg';
        ...
        Mail::send('emails.emp_reg', ['user' => $user, 'password' => '123456'], function($message) use($user)
        {
