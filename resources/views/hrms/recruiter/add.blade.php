    ...
    <header id="topbar" class="alt">
        <div class="topbar-left">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-current-item"> Add Candidate </li>
            </ol>
        </div>
    </header>
    <!-- -------------- Content -------------- -->
                    ...
                    <div class="box box-success">
                        <div class="panel">
                            <div class="panel-heading">
                                <span class="panel-title hidden-xs"> Add Candidate </span>
                            </div>
                                    ...
                                    <div class="panel-body p25 pb10">
                                        ...
                                        {!! Form::open(['class' => 'form-horizontal', 'url' => route('recruiter.store'), 'method' => 'post', 'files' => true]) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="skypeid" id="skypeid" class="form-control" placeholder="Skype ID" required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="mobile_num" id="mobile_num" max="10" maxlength="10" class="form-control" placeholder="Mobile Number" required />
                                                </div>
                                            </div>
