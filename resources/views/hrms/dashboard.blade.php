        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="panel panel-tile">
                    <div class="panel-body">
                        <div class="row pv10">
                            <div class="col-xs-5 ph10"><img src="{{ asset('/public/assets/img/pages/clipart0.png') }}" class="img-responsive mauto" alt=""/></div>
                            <div class="col-xs-7 pl5">
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="panel panel-tile">
                        <div class="panel-body">
                            <div class="row pv10">
                                <div class="col-xs-5 ph10"><img src="{{ asset('/public/assets/img/pages/Laptop Sketch-64x64') }}" class="img-responsive mauto" style="height: 100px; width: 100px;" alt=""/></div>
                                <div class="col-xs-7 pl5">
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="panel panel-tile">
                        <div class="panel-body">
                            <div class="row pv10">
                                <div class="col-xs-5 ph10"><img src="{{ asset('/public/assets/img/pages/dollar.jpg') }}" class="img-responsive mauto" style="height: 100px; width: 100px;" alt=""/></div>
                                <div class="col-xs-7 pl5">
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="panel panel-tile">
                    <div class="panel-body">
                        <div class="row pv10">
                            <div class="col-xs-5 ph10"><img src="{{ asset('/public/assets/img/pages/clipart5.png') }}" class="img-responsive mauto" alt=""/></div>
                            <div class="col-xs-7 pl5">
