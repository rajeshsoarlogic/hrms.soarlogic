        ...
        <header id="topbar" class="alt">
            <div class="topbar-left">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-current-item"> Add Company Expense </li>
                    </ol>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <span class="panel-title hidden-xs"> Add Company Expense</span>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <div class="panel-body p25 pb10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="item" id="item" class="form-control" placeholder="Item bought" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="purchase_from" id="purchase_from" class="form-control" placeholder="Item bought from" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="date_of_purchase" class="select2-single form-control" name="date_of_purchase" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="amount" id="amount" class="form-control" placeholder="price" required>
                                            </div>
                                        </div>
