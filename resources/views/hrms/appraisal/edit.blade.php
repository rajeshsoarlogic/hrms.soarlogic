    ...
    <header id="topbar" class="alt">
        <div class="topbar-left">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-current-item"> Edit Appraisal Letter </li>
            </ol>
        </div>
    </header>
    <!-- -------------- Content -------------- -->
                    ...
                    <div class="box box-success">
                        <div class="panel">
                            <div class="panel-heading">
                                <span class="panel-title hidden-xs"> Edit Appraisal Letter </span>
                            </div>
                            ...
                            <div class="panel-body pn">
                                <div class="table-responsive">
                                    <div class="panel-body p25 pb10">
                                        ...
                                        @endif
                                        {!! Form::open(['class' => 'form-horizontal', 'url' => route('appraisal.update', $appraisal->id), 'method' => 'put']) !!}
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <select name="user_id" id="user_id" class="form-control" required>
                                                        ...
                                                        @foreach($emps as $emp)
                                                            <option value="{{$emp->id}}" data-photo="{{asset('public/photos/'.$emp->employee->photo)}}" @if($emp->id == $appraisal->user_id) selected @endif>{{$emp->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-10">
                                                    <select name="template_id" id="template_id" class="form-control" required>
                                                        ...
                                                        @foreach($templates as $template)
                                                            <option value="{{$template->id}}" data-description="{{$template->description}}" @if($template->id == $appraisal->template_id) selected @endif>{{$template->title}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea name="description" id="description" class="ckeditor form-control">{{$appraisal->description}}</textarea>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-10">
                                                    <select name="stamp_id" id="stamp_id" class="form-control" required>
                                                        ...
                                                        @foreach($stamps as $stamp)
                                                            <option value="{{$stamp->id}}" @if($stamp->id == $appraisal->stamp_id) selected @endif>{{$stamp->title}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-4">
                                                    <select name="digital_signature_id" id="digital_signature_id" class="form-control" required>
                                                        ...
                                                        @foreach($signatures as $sig)
                                                            <option value="{{$sig->id}}" data-signature="{{asset('storage/app/signature/'.$sig->signature)}}" @if($sig->id == $appraisal->digital_signature_id) selected @endif>{{$sig->title}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
