    ...
    <header id="topbar" class="alt">
        <div class="topbar-left">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-current-item"> Offer Letter Listings </li>
            </ol>
        </div>
    </header>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title hidden-xs"> Offer Letter Lists </span>
                        </div>
                                    ...
                                    @foreach($offerLetters as $offer)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{asset('storage/app/offerletter/'.$offer->pdf_name)}}" target="_blank">
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group text-right">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li>
                                                            <a href="{{ route('offer-letter.edit', $offer->id) }}">Edit</a>
                                                        </li>
                                                        <li>
                                                            <form id="del-offer-{{$offer->id}}" action="{{ route('offer-letter.destroy', [ 'id'=> $offer->id ]) }}" method="POST" >
                                                                {{ csrf_field() }}
                                                                {{ method_field('DELETE') }}
