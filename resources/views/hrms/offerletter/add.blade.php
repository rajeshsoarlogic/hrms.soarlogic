    ...
    <header id="topbar" class="alt">
        <div class="topbar-left">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-current-item"> Add Offer Letter </li>
            </ol>
        </div>
    </header>
    <!-- -------------- Content -------------- -->
                    ...
                    <div class="box box-success">
                        <div class="panel">
                            <div class="panel-heading">
                                <span class="panel-title hidden-xs"> Add Offer Letter </span>
                            </div>
                                    ...
                                    <div class="panel-body p25 pb10">
                                        ...
                                        {!! Form::open(['class' => 'form-horizontal', 'url' => route('offer-letter.store'), 'method' => 'post']) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="other_emails" id="other_emails" class="form-control" placeholder="Other comma seperated emails...">
                                                </div>
                                            </div>
