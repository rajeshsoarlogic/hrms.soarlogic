    ...
    <header id="topbar" class="alt">
        <div class="topbar-left">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-current-item"> Edit Employee Performance </li>
            </ol>
        </div>
    </header>
    <!-- -------------- Content -------------- -->
                    ...
                    <div class="box box-success">
                        <div class="panel">
                            <div class="panel-heading">
                                <span class="panel-title hidden-xs"> Edit Employee Performance </span>
                            </div>
                            ...
                            <div class="panel-body pn">
                                <div class="table-responsive">
                                    <div class="panel-body p25 pb10">
                                        ...
                                        @endif
                                        {!! Form::open(['class' => 'form-horizontal', 'url' => route('employee-performance.update', $employeePerformance->id), 'method' => 'put']) !!}
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="employee_id" id="employee_id" class="form-control" required>
                                                        ...
                                                        @foreach($emps as $emp)
                                                            <option value="{{$emp->id}}" @if($emp->id == $employeePerformance->employee_id) selected @endif>{{$emp->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="reviewer_name" id="reviewer_name" value="{{$employeePerformance->reviewer_name}}" class="form-control" required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="reviewer_title" id="reviewer_title" value="{{$employeePerformance->reviewer_title}}" class="form-control" required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="date" name="review_date" id="review_date" value="{{$employeePerformance->review_date}}" class="form-control" required />
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-10">
                                                    <select name="potential" id="potential" class="form-control" required>
                                                        ...
                                                        @foreach($qualities as $key => $quality)
                                                            <option value="{{$key}}" @if($employeePerformance->potential == $key) selected @endif>{{$quality}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="work_quality" id="work_quality" class="form-control" required>
                                                        <option value="">--- SELECT ---</option>
                                                        @foreach($qualities as $key => $quality)
                                                            <option value="{{$key}}" @if($employeePerformance->work_quality == $key) selected @endif>{{$quality}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="work_consistency" id="work_consistency" class="form-control" required>
                                                        <option value="">--- SELECT ---</option>
                                                        @foreach($qualities as $key => $quality)
                                                            <option value="{{$key}}" @if($employeePerformance->work_consistency == $key) selected @endif>{{$quality}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="communication" id="communication" class="form-control" required>
                                                        <option value="">--- SELECT ---</option>
                                                        @foreach($qualities as $key => $quality)
                                                            <option value="{{$key}}" @if($employeePerformance->communication == $key) selected @endif>{{$quality}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="independent_work" id="independent_work" class="form-control" required>
                                                        <option value="">--- SELECT ---</option>
                                                        @foreach($qualities as $key => $quality)
                                                            <option value="{{$key}}" @if($employeePerformance->independent_work == $key) selected @endif>{{$quality}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="takes_initiative" id="takes_initiative" class="form-control" required>
                                                        <option value="">--- SELECT ---</option>
                                                        @foreach($qualities as $key => $quality)
                                                            <option value="{{$key}}" @if($employeePerformance->takes_initiative == $key) selected @endif>{{$quality}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="group_work" id="group_work" class="form-control" required>
                                                        <option value="">--- SELECT ---</option>
                                                        @foreach($qualities as $key => $quality)
                                                            <option value="{{$key}}" @if($employeePerformance->group_work == $key) selected @endif>{{$quality}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="productivity" id="productivity" class="form-control" required>
                                                        <option value="">--- SELECT ---</option>
                                                        @foreach($qualities as $key => $quality)
                                                            <option value="{{$key}}" @if($employeePerformance->productivity == $key) selected @endif>{{$quality}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="creativity" id="creativity" class="form-control" required>
                                                        <option value="">--- SELECT ---</option>
                                                        @foreach($qualities as $key => $quality)
                                                            <option value="{{$key}}" @if($employeePerformance->creativity == $key) selected @endif>{{$quality}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="honesty" id="honesty" class="form-control" required>
                                                        <option value="">--- SELECT ---</option>
                                                        @foreach($qualities as $key => $quality)
                                                            <option value="{{$key}}" @if($employeePerformance->honesty == $key) selected @endif>{{$quality}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="integrity" id="integrity" class="form-control" required>
                                                        <option value="">--- SELECT ---</option>
                                                        @foreach($qualities as $key => $quality)
                                                            <option value="{{$key}}" @if($employeePerformance->integrity == $key) selected @endif>{{$quality}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="coworker_relations" id="coworker_relations" class="form-control" required>
                                                        <option value="">--- SELECT ---</option>
                                                        @foreach($qualities as $key => $quality)
                                                            <option value="{{$key}}" @if($employeePerformance->coworker_relations == $key) selected @endif>{{$quality}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="client_relations" id="client_relations" class="form-control" required>
                                                        <option value="">--- SELECT ---</option>
                                                        @foreach($qualities as $key => $quality)
                                                            <option value="{{$key}}" @if($employeePerformance->client_relations == $key) selected @endif>{{$quality}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="technical_skills" id="technical_skills" class="form-control" required>
                                                        <option value="">--- SELECT ---</option>
                                                        @foreach($qualities as $key => $quality)
                                                            <option value="{{$key}}" @if($employeePerformance->technical_skills == $key) selected @endif>{{$quality}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="dependability" id="dependability" class="form-control" required>
                                                        <option value="">--- SELECT ---</option>
                                                        @foreach($qualities as $key => $quality)
                                                            <option value="{{$key}}" @if($employeePerformance->dependability == $key) selected @endif>{{$quality}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="punctuallity" id="punctuallity" class="form-control" required>
                                                        <option value="">--- SELECT ---</option>
                                                        @foreach($qualities as $key => $quality)
                                                            <option value="{{$key}}" @if($employeePerformance->punctuallity == $key) selected @endif>{{$quality}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="attendance" id="attendance" class="form-control" required>
                                                        <option value="">--- SELECT ---</option>
                                                        @foreach($qualities as $key => $quality)
                                                            <option value="{{$key}}" @if($employeePerformance->attendance == $key) selected @endif>{{$quality}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea name="previous_review_goals_achieved" id="previous_review_goals_achieved" class="ckeditor form-control" required>{{$employeePerformance->previous_review_goals_achieved}}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea name="goals_for_next_review" id="goals_for_next_review" class="ckeditor form-control" required>{{$employeePerformance->goals_for_next_review}}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea name="comment_and_approval" id="comment_and_approval" class="ckeditor form-control" required>{{$employeePerformance->comment_and_approval}}</textarea>
                                                </div>
                                            </div>
