                                ...
                                <section class="wizard-section">
                                    <div class="section">
                                        ...
                                        <label class="field prepend-icon append-button file">
                                            ...
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                <input type="hidden" value="{{route('edit-emp', $emps->id)}}" id="url">
                                    ...
                                    <div class="section">
                                        <label for="emp_email"><h6 class="mb20 mt40">Employee Email </h6></label>
                                        <label for="emp_email" class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                <input type="email" name="emp_email" id="emp_email" class="gui-input" value="@if($emps && $emps->email){{$emps->email}}@endif" required>
                                                <label for="emp_email" class="field-icon">
                                                    <i class="fa fa-user"></i>
                                                </label>
                                            @else
                                                <input type="email" name="emp_email" id="emp_email" class="gui-input" placeholder="employee email..." required>
                                                <label for="emp_email" class="field-icon">
                                                    <i class="fa fa-user"></i>
                                                </label>
                                            @endif
