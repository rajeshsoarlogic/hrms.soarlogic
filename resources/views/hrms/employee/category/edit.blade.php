    ...
    <header id="topbar" class="alt">
        <div class="topbar-left">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-current-item"> Edit Employee Category </li>
            </ol>
        </div>
    </header>
    <!-- -------------- Content -------------- -->
                    ...
                    <div class="box box-success">
                        <div class="panel">
                            <div class="panel-heading">
                                <span class="panel-title hidden-xs"> Edit Employee Category </span>
                            </div>
                            ...
                            <div class="panel-body pn">
                                <div class="table-responsive">
                                    <div class="panel-body p25 pb10">
                                        ...
                                        @endif
                                        {!! Form::open(['class' => 'form-horizontal', 'url' => route('employee-category.update', $category->id), 'method' => 'put']) !!}
