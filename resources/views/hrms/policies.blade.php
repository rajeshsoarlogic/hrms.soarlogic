                        ...
                        <div class="panel-group accordion" id="accordion1">
                            <div class="panel">
                                <div class="panel-heading">
                                    <a class="accordion-toggle accordion-icon link-unstyled collapsed" data-toggle="collapse" data-parent="#accordion1" href="#accordion1_1">
                                        1. Code of Conduct
                                    </a>
                                </div>
                                <div id="accordion1_1" class="panel-collapse collapse" style="height: 0px;">
                                    <div class="panel-body">
                                        <iframe src="/HTML/index.html" width="100%" height="400px"></iframe>
                                    </div>
                                </div>
                            </div>
