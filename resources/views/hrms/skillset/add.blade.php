    ...
    <header id="topbar" class="alt">
        <div class="topbar-left">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-current-item"> Add Skill </li>
            </ol>
        </div>
    </header>
    <!-- -------------- Content -------------- -->
                    ...
                    <div class="box box-success">
                        <div class="panel">
                            <div class="panel-heading">
                                <span class="panel-title hidden-xs"> Add Skill </span>
                            </div>
                            ...
                            <div class="panel-body pn">
                                <div class="table-responsive">
                                    <div class="panel-body p25 pb10">
                                        ...
                                        @endif
                                        {!! Form::open(['class' => 'form-horizontal createForm', 'url' => route('skill-set.store'), 'method' => 'post']) !!}
